...
if(aa.length&&window.insloader){
var _4=[];
for(var i=0;i<aa.length;i++){
_4.push(aa[i].name);
}
insloader.load(_4,function(){
for(var i=0;i<aa.length;i++){
var _5=aa[i].name;
var jq=aa[i].jq;
jq[_5]();
...
d.remove();
if(!window.insloader&&$.parser.auto){
$.parser.parse();
}
});
...
if(r1||r2){
$(this).addClass("insui-fluid");
}else{
$(this).removeClass("insui-fluid");
}
});
}
...
if($(this).hasClass("insui-fluid")||_9e){
_84(this);
}
return false;
});
...
if(_ec.id==undefined){
_ec.id="insui_tree_node_id_temp";
_127(_e6,_ec);
}
...
if(_ed&&_ed.id=="insui_tree_node_id_temp"){
_ed.id="";
_127(_e6,_ed);
}
...
if($(this).hasClass("insui-fluid")||_1dd){
_1de(_1dc);
}
return false;
});
...
if($(this).hasClass("insui-fluid")||_21c){
_20c(_21a);
}
return false;
});
...
if(_255.length){
_255.layout("resize");
$("body").children(".insui-fluid:visible").each(function(){
...
var s=$(_260).find("div.panel:visible,div.accordion:visible,div.tabs-container:visible,div.layout:visible,.insui-fluid:visible").filter(function(_262,el){
...
tb.add(bb)._outerWidth(t._outerWidth()).find(".insui-fluid:visible").each(function(){
$(this).triggerHandler("_resize");
});
if(!isNaN(parseInt(opts.height))){
...
if($(this).hasClass("insui-fluid")||_2d3){
_2b2(_2d1);
}
return false;
});
...
p_t.find(".insui-fluid:visible").triggerHandler("_resize");
};
};
function _325(_326){
...
if($(this).hasClass("insui-fluid")||_32e){
_319(_32c);
_325(_32c);
}
return false;
...
if($(this).hasClass("insui-fluid")||_39f){
_393(_39d);
}
return false;
});
...
if($(this).hasClass("insui-fluid")||_3e4){
...
if($(this).hasClass("insui-fluid")||_444){
_445(_442);
}
return false;
});
...
if($(this).hasClass("insui-fluid")||_4c9){
_4b1(_4c2);
}
return false;
});
...
var _507="insui_frame_"+(new Date().getTime());
...
if($(this).hasClass("insui-fluid")||_54a){
_545(_549);
}
return false;
});
...
var ss=["<style type=\"text/css\" insui=\"true\">"];
...
ss.push("</style>");
$(ss.join("\n")).appendTo(cc);
cc.children("style[insui]:not(:last)").remove();
},getRule:function(_5c5){
var _5c6=cc.children("style[insui]:last")[0];
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{sharedStyleSheet:false,frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Обработка, подождите пожалуйста...",rownumbers:false,singleSelect:false,ctrlSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:10,pageList:[10,20,30,40,50],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowEvents:{mouseover:_621(true),mouseout:_621(false),click:_629,dblclick:_633,contextmenu:_637},rowStyler:function(_7c3,_7c4){
...
_985++;
_9b7.itemIdPrefix="_insui_combobox_i"+_985;
_9b7.groupIdPrefix="_insui_combobox_g"+_985;
...
if($(this).hasClass("insui-fluid")||_a79){
_a7a(_a77);
}
return false;
});
